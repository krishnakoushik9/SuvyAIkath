# Medha AI - Intelligent Educational Platform

![App Logo](assets/icons/logo.png)

Medha AI is a comprehensive educational application designed to enhance learning experiences through AI-powered features, interactive content, and personalized study tools. The app is built with Flutter and integrates Google's Gemini AI for intelligent quiz generation and learning assistance.
